...
def save_camera_data_to_files(device_id=0, rgb:bool=True, depth:bool=True, ir:bool=False, frames:int=150, outfile_pattern:str="output"):
    ...
    with pyrs.Service() as serv:
        ...
        if rgb:
            ...
            rgb_writer = cv2.VideoWriter(f'{outfile_pattern}_rgb.mp4', fourcc, 30, (rgb_stream.width,rgb_stream.height))
        if depth:
            ...
            depth_writer = cv2.VideoWriter(f'{outfile_pattern}_depth.mp4', fourcc, 30, (depth_stream.width, depth_stream.height), False)
        if ir:
